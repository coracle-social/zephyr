<script lang="ts">
  ...
  // From https://codepen.io/soju22/pen/xxGqJxj
  onMount(() => {
    ...
    const conf = {
      ...
      cscale: chroma.scale(['#459AFF', '#CC223D', '#9FF649']).mode('lch'),
      darken: -1.5,
      angle: Math.PI / 3,
      timeCoef: 0.05
    };
...
<canvas bind:this={canvas} class="fixed" style="height: 100vh; width: 100vw;"></canvas>
